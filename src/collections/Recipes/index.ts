...
import { notifyBrazeOfNewRecipe } from './hooks/notifyBrazeOfNewRecipe'
...
export const Recipes: CollectionConfig<'recipes'> = {
  ...
  // Type safe if the collection slug generic is passed to `CollectionConfig` - `CollectionConfig<'recipes'>
  defaultPopulate: {
    title: true,
    slug: true,
    categories: true,
  ...
  hooks: {
    afterChange: [revalidateRecipe, notifyBrazeOfNewRecipe],
